 ...
 *
 * Stratégie:
 * 1) Tous les "option anglais" vont dans le groupe 1
 ...
 * 4) si un groupe est < tailleMin, on déplace des étudiants depuis un groupe > tailleMin (sans toucher à la contrainte anglais).
 */
public class GloutonRedoublantsEquilibre implements GroupeAlgoS3 {
    ...
    public List<Groupe> generer(List<Etudiant> etudiants, ContraintesGroupesS3 c) {
        ...
        // 1) Place tous les "anglais" dans le groupe 1, sépare le reste.
     ...
     * Ne déplace jamais un étudiant option anglais hors du groupe anglais
     */
